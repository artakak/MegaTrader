...
class Chart(object):
    ...
    def __init__(self, api, pair, **kwargs):
        ...
        self.db = MongoClient("mongodb://artakak:aquasoft@cluster0-shard-00-00-vfkv9.mongodb.net:27017,cluster0-shard-00-01-vfkv9.mongodb.net:27017,cluster0-shard-00-02-vfkv9.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin")['poloniex']['%s_%s_chart' %
